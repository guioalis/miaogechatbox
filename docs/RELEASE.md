...
### Windows
- `猫盒子-{version}-win-x64.exe` - NSIS 安装程序
- `猫盒子-{version}-win-x64.zip` - 便携版

### macOS
- `猫盒子-{version}-mac-x64.dmg` - Intel 芯片 DMG 镜像
- `猫盒子-{version}-mac-arm64.dmg` - Apple Silicon DMG 镜像
- `猫盒子-{version}-mac-x64.zip` - Intel 芯片便携版
- `猫盒子-{version}-mac-arm64.zip` - Apple Silicon 便携版
